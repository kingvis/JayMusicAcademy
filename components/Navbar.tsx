      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <motion.button
            ...
            className="md:hidden p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden glass backdrop-blur-md border-t border-gray-200 dark:border-gray-700 bg-white/90 dark:bg-gray-900/90"
          >
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                {contactInfo.map((contact, index) => (
                  <motion.a
                    ...
                    className="flex items-center space-x-3 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors py-2"
                  >
                  ...
                  <div className="space-y-3">
                    ...
                    <SignUpButton mode="modal">
                      <motion.button
                        whileTap={{ scale: 0.95 }}
                        onClick={() => setIsOpen(false)}
                        className="w-full px-4 py-2 border border-blue-500 dark:border-blue-400 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200"
                      >
                        Create Account
                      </motion.button>
                    </SignUpButton>
